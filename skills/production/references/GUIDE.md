...
This guide provides comprehensive documentation for the **production** skill in the custom-plugin-android plugin.
...
```bash
# Invoke the skill
claude "production - [your task description]"

# Example
claude "production - analyze the current implementation"
```
...
def implement_production(input_data):
    """
