...
This guide provides comprehensive documentation for the **data** skill in the custom-plugin-android plugin.
...
```bash
# Invoke the skill
claude "data - [your task description]"

# Example
claude "data - analyze the current implementation"
```
...
def implement_data(input_data):
    """
    Implement data functionality.
