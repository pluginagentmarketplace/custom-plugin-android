...
This guide provides comprehensive documentation for the **platform** skill in the custom-plugin-android plugin.
...
```bash
# Invoke the skill
claude "platform - [your task description]"

# Example
claude "platform - analyze the current implementation"
```
...
def implement_platform(input_data):
    """
    Implement platform functionality.
