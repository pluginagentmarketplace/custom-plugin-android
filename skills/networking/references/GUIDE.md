...
This guide provides comprehensive documentation for the **networking** skill in the custom-plugin-android plugin.
...
```bash
# Invoke the skill
claude "networking - [your task description]"

# Example
claude "networking - analyze the current implementation"
```
...
def implement_networking(input_data):
    """
