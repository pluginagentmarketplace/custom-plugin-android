...
This guide provides comprehensive documentation for the **ui** skill in the custom-plugin-android plugin.
...
```bash
# Invoke the skill
claude "ui - [your task description]"

# Example
claude "ui - analyze the current implementation"
```
